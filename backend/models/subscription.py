...
class Subscription(db.Model):
    ...
    # Usage limits
    max_projects = db.Column(db.Integer, default=3)  # projects default
    ...
    trial_end = db.Column(db.DateTime, default=lambda: datetime.utcnow() + timedelta(days=7)) # Default 7-day trial
