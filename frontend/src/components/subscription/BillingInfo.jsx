    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Manage your payment methods, billing address, and view invoice history
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h4 className="text-sm font-medium text-blue-900 mb-3">💡 Billing Help:</h4>
          <ul className="text-sm text-blue-800 space-y-2">
            <li>• <strong>Payment Method:</strong> Update your card details or add backup payment methods</li>
            <li>• <strong>Billing Address:</strong> Keep your company information up-to-date for accurate invoicing</li>
            <li>• <strong>Invoice History:</strong> Download past invoices for your accounting records</li>
            <li>• All payments are processed securely through our encrypted payment system</li>
          </ul>
        </div>
      </div>
