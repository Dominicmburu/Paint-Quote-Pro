...
const About = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      bio: t("AI expert with background in computer vision and machine learning. Mike leads our technical innovation and product development."),
  ...
  const values = [
    {
      ...
      description: t("Every feature we build is designed with our customers' success in mind. Your feedback drives our product development and shapes our roadmap.")
    },
    {
      icon: <Lightbulb className="h-12 w-12 text-amber-600" />,
      title: t("Innovation"),
      description: t("We leverage the latest AI technology to solve real problems faced by painting professionals every day. We're always pushing boundaries.")
    },
    {
      icon: <Shield className="h-12 w-12 text-blue-600" />,
      title: t("Reliability"),
      description: t("We're committed to delivering a product that exceeds expectations and helps our customers achieve their business goals consistently.")
    }
  ];

  const stats = [
    { number: "500+", label: t("Happy Painters") },
    { number: "10,000+", label: t("Quotes Generated") },
    { number: "50,000+", label: t("Hours Saved") },
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div>
              ...
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
                ...
                <p>
                  ...
                  {t('Sarah recalls. "There had to be a better way."')}
                </p>
                <p>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800 mb-4">{t('Founded in 2022')}</h3>
                  <p className="text-slate-600 leading-relaxed">
                    {t("Started by painting professionals, for painting professionals. We understand your challenges because we've lived them.")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">{t('Our Values')}</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              {t("These principles guide everything we do and every decision we make")}
            </p>
          </div>
      ...
      <section className="py-20 bg-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-8">{t('Our Mission')}</h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-2xl text-slate-700 leading-relaxed mb-8 font-medium">
                {t('"To empower every painting professional with the tools they need to create better quotes faster, win more jobs, and build successful businesses."')}
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-bold text-slate-800 mb-2">{t('Speed')}</h3>
                  <p className="text-slate-600">{t('Create quotes 5x faster than traditional methods')}</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-amber-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Target className="h-8 w-8 text-white" />
                  </div>
                  <h3 className="text-lg font-bold text-slate-800 mb-2">{t('Accuracy')}</h3>
                  <p className="text-slate-600">{t('95% measurement accuracy with AI technology')}</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Award className="h-8 w-8 text-white" />
                  </div>
                  <h3 className="text-lg font-bold text-slate-800 mb-2">{t('Quality')}</h3>
                  <p className="text-slate-600">{t('Professional quotes that win more business')}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">{t("Why We're Different")}</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              {t("We're not just another software company - we're painters who built a solution for painters")}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-800 mb-2">{t("Built by Industry Experts")}</h3>
                  <p className="text-slate-600 leading-relaxed">{t("Our founders have decades of combined experience in the painting industry. We understand your challenges because we've faced them ourselves.")}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-800 mb-2">{t("Customer-Driven Development")}</h3>
                  <p className="text-slate-600 leading-relaxed">{t("Every feature is requested and tested by real painting contractors. We don't build features in isolation - we build what you actually need.")}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-800 mb-2">{t("Continuous Innovation")}</h3>
                  <p className="text-slate-600 leading-relaxed">{t("We're constantly improving our AI technology and adding new features. Your subscription includes all updates and new capabilities.")}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <p className="text-slate-600 italic mb-4">{t('"The AI is incredibly accurate, and the quotes look so professional. I\'ve won every job I\'ve quoted since switching."')}</p>
                  <p className="font-semibold text-slate-800">- {t("Lisa Rodriguez, Precision Painters")}</p>
                </div>
              </div>
            </div>
          </div>
