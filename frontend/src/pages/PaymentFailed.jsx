...
const PaymentFailed = () => {
  ...
  const commonIssues = [
    ...
    },
    {
      ...
      solution: "Contact your bank to authorize the payment or use a different card."
    },
    {
      title: "Expired Card",
      description: "The payment card may have expired.",
      solution: "Update your card information with a valid, non-expired card."
    },
    {
      title: "Incorrect Details",
      description: "Card number, CVV, or billing address may be incorrect.",
      solution: "Double-check all card details and billing information."
    }
  ];

  const alternativePaymentMethods = [
    {
      name: "Different Credit Card",
      description: "Try using a different credit or debit card",
      icon: <CreditCard className="h-6 w-6 text-blue-600" />
    },
    {
      name: "Contact Your Bank",
      description: "Call your bank to authorize the payment",
      icon: <Phone className="h-6 w-6 text-green-600" />
    },
    {
      name: "Contact Support",
      description: "Our team can help with payment issues",
    ...
    <div className="min-h-screen bg-yellow-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">
              Don't worry - this happens sometimes. Your card was not charged and we can help you resolve this quickly.
            </p>
          </div>
        ...
        <div className="bg-gradient-to-r from-green-500 to-blue-500 rounded-2xl p-8 text-white text-center">
          <h3 className="text-xl font-bold mb-4">No Credit Card? No Problem!</h3>
          <p className="text-green-100 mb-6">
            Start with our 14-day free trial. You can add payment details later when you're ready to continue.
          </p>
          <button
        ...
        <div className="mt-8 bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              ...
              <h4 className="font-semibold text-purple-700 mb-2">Email Support</h4>
              <p className="text-gray-600 text-sm mb-3">Get help within 2 hours</p>
              <button
            ...
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              ...
              <h4 className="font-semibold text-purple-700 mb-2">Phone Support</h4>
              <p className="text-gray-600 text-sm mb-3">Available Mon-Fri 9AM-6PM</p>
              <button
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 text-sm">
            If contacting support, please reference error code: 
