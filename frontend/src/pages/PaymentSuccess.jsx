  ...
  useEffect(() => {
    const fetchSessionDetails = async () => {
      try {
        ...
        if (!sessionId) {
          setError(t('No session ID found in URL'));
          setLoading(false);
          return;
        }
    ...
    return (
      <div className="min-h-screen bg-yellow-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">{t('Loading your subscription details...')}</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-yellow-50 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 max-w-md">
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold text-red-700 mb-2">{t('Unable to Load Details')}</h2>
      ...
      <div className="bg-gradient-to-r from-[#4bb4f5] to-[#4bb4f5] py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center">
            ...
            <h1 className="text-3xl font-bold text-white">{t('Payment Successful!')}</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">
              {t('Your {{plan}} subscription is now active. You\'re ready to create professional paint quotes in minutes!', {
                plan: sessionDetails?.plan_name?.toLowerCase() === 'professional' ? 
                  t('Professional') : 
          ...
          <div className="bg-green-50 rounded-xl p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-600">{t('Next billing:')}</span>
                <span className="font-semibold text-[#4bb4f5] ml-2 text-sm">
          ...
          <div className="bg-purple-50 rounded-xl p-6 mb-8">
            <h3 className="text-lg font-semibold text-[#4bb4f5] mb-4 flex items-center">
              ...
              {t('What\'s Included in Your Plan')}
            </h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-[#4bb4f5] mb-2">{t('Upload Floor Plan')}</h4>
              <p className="text-gray-600 text-sm">{t('Upload your project\'s floor plan and let our AI analyze it')}</p>
            </div>
            <div className="text-center">
              <div className="bg-purple-100 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
                <span className="text-[#4bb4f5] font-bold text-lg">2</span>
              </div>
              <h4 className="font-semibold text-[#4bb4f5] mb-2">{t('Review Analysis')}</h4>
              <p className="text-gray-600 text-sm">{t('Check surface areas and measurements calculated by AI')}</p>
            </div>
            <div className="text-center">
              <div className="bg-purple-100 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
                <span className="text-[#4bb4f5] font-bold text-lg">3</span>
              </div>
              <h4 className="font-semibold text-[#4bb4f5] mb-2">{t('Generate Quote')}</h4>
              <p className="text-gray-600 text-sm">{t('Create professional PDF quotes in seconds')}</p>
            </div>
          </div>
        </div>        
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600 text-sm">
            {t('A receipt has been sent to {{email}}.', {email: sessionDetails?.customer_email})}
          </p>
        </div>
      </div>
    </div>
