      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-green-50 rounded-xl p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <span className="font-semibold text-purple-700 ml-2 text-sm">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-purple-700 mb-2">Upload Floor Plan</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-purple-700 mb-2">Review Analysis</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-purple-700 mb-2">Generate Quote</h4>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600 text-sm">
            A receipt has been sent to {sessionDetails?.customer_email}. You can also view your billing details in your 
            <span 
              onClick={() => window.location.href = '/subscription/billing'}
              className="text-purple-600 hover:text-purple-700 ml-1 cursor-pointer font-semibold"
            >
              account settings
            </span>
            .
