    ...
    <div className="min-h-screen bg-yellow-50 flex items-center justify-center">
      <div className="max-w-md mx-auto text-center px-4">
        <div className="mb-8">
          ...
          <h2 className="text-3xl font-bold text-purple-700 mb-4">{t('Page Not Found')}</h2>
          <p className="text-gray-600 mb-8">
            {t('Sorry, we couldn\'t find the page you\'re looking for. It might have been moved, deleted, or you entered the wrong URL.')}
          </p>
        </div>
