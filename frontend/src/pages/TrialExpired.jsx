  ...
  const trialHighlights = [
    {
      ...
      description: t("painting projects during your trial")
    },
    {
      icon: <Star className="h-6 w-6 text-yellow-600" />,
      title: t("Quotes Generated"), 
      value: trialStats.quotesGenerated,
      description: t("professional quotes created")
    },
    {
    ...
    <div className="min-h-screen bg-yellow-50">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center">
            ...
            <h1 className="text-3xl font-bold text-white">{t('Your Trial Has Ended')}</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-8">
          ...
          >
            <span>{t('Continue with {{planName}}', { planName: plans.find(p => p.id === selectedPlan)?.name })}</span>
            <ArrowRight className="h-5 w-5 ml-2" />
          </button>
          <p className="text-gray-500 text-sm mt-3">
            {t('Resume immediately • All your data preserved • Cancel anytime')}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
          <h3 className="text-xl font-bold text-purple-700 mb-6 text-center">
            {t('What you\'ll get when you subscribe:')}
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="font-semibold text-purple-700 mb-4 flex items-center">
                ...
                {t('Your Existing Data')}
              </h4>
              <ul className="space-y-2">
                <li className="flex items-center text-gray-700">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-3" />
                  <span className="text-sm">{t('All {{count}} projects preserved', { count: trialStats.projectsCreated })}</span>
                </li>
                <li className="flex items-center text-gray-700">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-3" />
                  <span className="text-sm">{t('Your {{count}} generated quotes', { count: trialStats.quotesGenerated })}</span>
                </li>
                <li className="flex items-center text-gray-700">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-3" />
                  <span className="text-sm">{t('Company settings & branding')}</span>
                </li>
                <li className="flex items-center text-gray-700">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-3" />
                  <span className="text-sm">{t('Paint brand preferences')}</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center text-gray-700">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-3" />
                  <span className="text-sm">{t('Unlimited project creation')}</span>
                </li>
                <li className="flex items-center text-gray-700">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-3" />
                  <span className="text-sm">{t('Advanced AI analysis features')}</span>
                </li>
                <li className="flex items-center text-gray-700">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-3" />
                  <span className="text-sm">{t('Custom quote templates')}</span>
                </li>
                <li className="flex items-center text-gray-700">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-3" />
                  <span className="text-sm">{t('Team collaboration tools')}</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-green-500 to-blue-500 rounded-2xl p-8 text-white text-center">
          <h3 className="text-2xl font-bold mb-4">{t('🎉 Special Trial Conversion Offer')}</h3>
          <p className="text-green-100 mb-6 text-lg">
            {t('Subscribe today and get your first month at 25% off! This offer expires in 48 hours.')}
          </p>
          ...
          <p className="text-green-100 text-sm mt-4">
            {t('Offer code: TRIAL25 • Valid for 48 hours only')}
          </p>
        </div>

        {/* Support and Options */}
        <div className="mt-8 text-center">
          <p className="text-gray-600 mb-4">{t('Need more time to decide or have questions?')}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
